...
* DENKFOUT GEVONDEN:
** indien eigendom gekoppeld wordt aan twee adressen, dan wordt er plaats gemaakt voor 2* het aantal huidig_bewoon ipv één maal
** bijvoorbeeld
...
hierdoor worden de huishoudens slechts één keer toegekend. 
